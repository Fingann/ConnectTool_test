...
namespace ConnectTool.Model.LogWatcher
{
    ...
    public class WatcherEx : IDisposable
    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (disposing)
            {
                ////logger.Trace("WatcherEx is Disposing");
                //Debug.WriteLine("WatcherEx.Dispose()");
                if (!this.disposed)
                {
                    DisposeWatchers();
        ...
        {
            //logger.Trace("WatcherEx is disposing Watchers");
        ...
        /// <returns></returns>
        public bool HandleNotifyFilter(NotifyFilters filter) => (watcherInfo.ChangesFilters & filter) == filter;
        ...
        {
            //logger.Trace("WatcherEx is Initializing");
            ...
            //logger.Trace("WatcherEx is Initialized - {0} - Watchers where created",watchers.Count);
        }
        ...
        public void Start()
        {
            //logger.Trace("WatcherEx Starting");
        ...
        public void Stop()
        {
            //logger.Trace("WatcherEx Stopping");
        ...
        {
            //logger.Trace("WatcherEx EVENT - Attribute");
        ...
        {
            //logger.Trace("WatcherEx EVENT - CreationTime");
        ...
        {
            //logger.Trace("WatcherEx EVENT - DirectoryName");
        ...
        {
            //logger.Trace("WatcherEx EVENT - FileName");
        ...
        {
            //logger.Trace("WatcherEx EVENT - LastAccess");
        ...
        {
            //logger.Trace("WatcherEx EVENT - LastWrite");
        ...
        {
            //logger.Trace("WatcherEx EVENT - Security");
        ...
        {
            //logger.Trace("WatcherEx EVENT - Changed Size");
        ...
        {
            //logger.Trace("WatcherEx EVENT - Disposed");
        ...
        {
            //logger.Trace("WatcherEx EVENT - Error");
        ...
        {
            //logger.Trace("WatcherEx EVENT - Renamed");
